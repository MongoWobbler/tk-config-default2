...
class SubstancePainterSessionPublishPlugin(HookBaseClass):
            ...
            self.logger.error(
                ...
                extra={
                    "action_button": {
                        ...
                        "v%s" % (version,),
                        "callback": lambda: self._save_session(next_version_path),
                    }
                },
            )
            raise Exception(error_msg)
    ...
    def publish(self, settings, item):
        ...
        ] = self._substancepainter_find_additional_session_dependencies()
    ...
    def finalize(self, settings, item):
        ...
        self._save_to_next_version(item.properties["path"], item, self._save_session)

    def _substancepainter_find_additional_session_dependencies(self):
        """
...
class BlenderSessionPublishPlugin(HookBaseClass):
    ...
    def publish(self, settings, item):
        ...
        item.properties[
            "publish_dependencies"
        ] = self._blender_find_additional_session_dependencies()
    ...
    def _blender_find_additional_session_dependencies(self):
        """
        Find additional dependencies from the session
        """
